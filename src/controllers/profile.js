...
module.exports = {
    ...
    updateUserProfile: async (req, res) => {
        ...
        if( req.isAuthenticated() ) {
            ...
            if( await User.findOne( { where: {email} } ) ) {
                return res.render(`profile`, { updateError: 'Um usuário com este endereço de e-mail já existe' });
            }
    ...
    updateUserPassword: async (req, res) => {
        ...
        if(bcrypt.compareSync(newPassword, user.password)) { 
            return res.render( `profile`, { passwordError: 'Senha nova não pode ser a igual à senha atual' } ); 
        }
        user.update( {
